...
public:
  ...
  TDragger();
  SoSFVec3f translation; //!< set from outside and used from outside for single
                         //!< precision.
...
public:
  static void initClass();
  RDragger();
  SoSFRotation rotation; //!< set from outside and used from outside for single
                         //!< precision.
...
public:
  ...
  SoSFVec3f translation; //!< initial translation and reflects single precision
                         //!< movement.
  SoSFDouble translationIncrement;      //!< set from outside used for rounding.
  SoSFInt32 translationIncrementCountX; //!< used from outside for translation x
                                        //!< steps.
  SoSFInt32 translationIncrementCountY; //!< used from outside for translation y
                                        //!< steps.
  SoSFInt32 translationIncrementCountZ; //!< used from outside for translation z
                                        //!< steps.
   ...
   * autoscale mode, scale represents a traditional scale and a value of 1.0 is
  ...
  SoIdleSensor
      idleSensor; //!< might be overkill, but want to make sure of performance.
  void setUpAutoScale(
